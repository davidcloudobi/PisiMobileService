...
namespace PisiMobile.BusinessCore.Service
{
    public class Subscriptions : ISubscriptions
    {
        ...
        public Subscriptions(DatabaseContext appDbContext)
        {
        ...
        public async Task<GlobalResponse> Subscribe(SubscribeInput request)
        {
            ...
            var service = await _appDbContext.PisiServices.FirstOrDefaultAsync(service => service.Id == request.Service_id);
